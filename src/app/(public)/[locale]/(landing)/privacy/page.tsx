  ...
  return (
    <div className="flex w-full flex-col items-start justify-start gap-2 sm:max-w-[768px]">
      <Card variant="textBlock" isButton={false}>
        <h1 className="mb-4 text-lg font-medium">{t("privacy.title")}</h1>
        <div className="flex flex-col items-start justify-start gap-2">
          ...
          <p>
            ...
            "Our" in this Agreement) refers to skydiary. Cookies are small files
            ...
            that website among its many uses. Country refers to the United
            States. Device means any device that can access the Service such as
            ...
            to assist the Company in analyzing how the Service is used. Usage
            ...
            example, the duration of a page visit). Website refers to skydiary,
            accessible from https://skydiary.app You means the individual
            ...
            information that can be used to contact You, and identify You.
            Personally identifiable information may include, but is not limited
            to: Email address First name and last name Address, State, Province,
            ZIP/Postal code, City, and Usage Data. Usage Data is collected
            ...
            Browser Cookies. A cookie is a small file placed on Your Device. You
            ...
            Service may use Cookies. Web Beacons. Certain sections of our
            ...
            accepted the use of cookies on the Website. Functionality Cookies
            ...
            every time You use the Website. For more information about the
            cookies we use and your choices regarding cookies, please visit our
            Cookies Policy or the Cookies section of our Privacy Policy. Use of
            Your Personal Data The Company may use Personal Data for the
            ...
            the Service. To contact You: To contact You by email, telephone
            calls, SMS, or other equivalent forms of electronic communication,
            such as a mobile application's push notifications regarding updates
            or informative communications related to the functionalities,
            products or contracted services, including the security updates,
            when necessary or reasonable for their implementation. To provide
            ...
            Providers to monitor and analyze the use of our Service. For
            ...
            are under common control with Us. With Your consent: We may disclose
            ...
            laws may differ than those from Your jurisdiction. Your consent to
            ...
            security of Your data and other personal information. Disclosure of
            Your Personal Data Business Transactions If the Company is involved
            ...
            government agency). Other legal requirements The Company may
            ...
            against legal liability Security of Your Personal Data The security
            of Your Personal Data is important to Us, but remember that no
            method of transmission over the Internet, or method of electronic
            storage is 100% secure. While We strive to use commercially
            acceptable means to protect Your Personal Data, We cannot guarantee
            its absolute security. Children's Privacy Our Service does not
            ...
            policies or practices of any third party sites or services. Changes
            ...
            any questions about this Privacy Policy, You can contact us by
            email: contact - at - skydiary - dot - app
          </p>
        </div>
      </Card>
    </div>
